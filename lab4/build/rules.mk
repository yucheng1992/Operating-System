...
CFLAGS	:= $(CFLAGS) $(DEFS) $(LABDEFS) -m32 -Os -ffreestanding -fomit-frame-pointer -I. -MD -Wall -Wno-format -Wno-unused -Werror -ggdb -nostdinc
...
QEMUOPT	= -net none -parallel file:log.txt -k en-us -icount 7
...
handin:
	...
	$(call run,$(MAKE) LAB=$(LAB_NUM) LAB_NAME=$(LAB_MAIN_NAME) -C .. handin,HANDIN)
...
.PHONY: all always clean realclean distclean dist distdir handin \
